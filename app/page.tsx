...
export default function Home() {
  ...
  return (
    <main className="site-shell">
      ...
      <footer className="footer"><Link className="brand" href="/" aria-label="skillbase 홈"><span className="brand-mark">s<span>·</span></span><span>skillbase</span></Link><span>AI Skills를 더 안전하고 쉽게.</span><Link href="/beta">베타 신청</Link><Link href="/privacy">개인정보</Link><Link href="/terms">이용약관</Link><Link href="/licenses">라이선스</Link><a href="/api/v1/manifest">API</a><span>© 2026 skillbase</span></footer>
